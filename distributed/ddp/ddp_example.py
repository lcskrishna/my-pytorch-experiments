...
if __name__ == '__main__':
    ...
    parser.add_argument("--total_epochs", type=int, required=True, help="Total epochs")
    parser.add_argument("--save_every", type=int, required=True, help="save every internval")
